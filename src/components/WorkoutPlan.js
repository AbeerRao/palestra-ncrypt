...
function WorkoutPlan() {
    ...
    const styles = {
        main: "w-1/2 h-full px-4 py-6 rounded-2xl text-white bg-black flex flex-col items-start justify-between space-y-3",
        ...
        workoutDiv: "flex flex-col items-center w-full h-full bg-white rounded-2xl space-y-3 px-4 py-12 text-black",
        ...
        <div className={styles.main}>
            ...
            <div className={styles.infoDiv}>
                <div className="flex flex-row items-center justify-between w-full">
                    <Image src={WkImg} className="bg-black rounded-full h-14 w-14 p-2" />
