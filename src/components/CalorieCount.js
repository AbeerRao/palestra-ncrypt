    ...
    return (
        <div className={styles.main}>
            <div className={styles.topDiv}>
                <h1 className="text-2xl font-semibold flex flex-row items-center"><p>Calorie</p><p className="ml-1 text-black">Count</p></h1>
                    ...
                    return (
                        <div className={styles.countDiv} key={index}>
                            <div className={styles.countLeft}>
                                {
                                    info.active ? 
                                    <div className="text-black font-semibold w-1/3">
                                        <h1>{info.day}</h1>
                                    </div> :
                            ...
                            <div className={styles.countRight}>
                                {
                                    info.active ? 
                                    <div style={{ width: `${info.progress}%` }} className="bg-black h-full rounded-full flex items-center justify-start pl-5">
                                        <h1>{info.calorie}</h1>
                                    </div>
                                    :
                                    <div style={{ width: `${info.progress}%` }} className="bg-white text-black opacity-75 h-full rounded-full flex items-center justify-start pl-5">
                                        <h1>{info.calorie}</h1>
                                    </div>
                                }   
                            </div>
