...
function HomeInfo() {
    ...
    const styles = {
        ...
        leftDiv: "w-1/5 bg-accent flex items-center justify-center 2xl:h-72 2xl:w-72 h-56 w-56 p-3 2xl:p-0 rounded-2xl shadow-2xl reveal fade-left",
        middleDiv: "w-2/5 flex flex-col items-start h-56 2xl:h-72 justify-between reveal fade-left",
        ...
        button: "border-2 border-[#151515] text-xl 2xl:text-2xl py-3 px-8 rounded-full hover:bg-[#151515] transition duration-300 ease-in-out cursor-pointer flex flex-row items-center space-x-1 group hover:scale-95",
        rightDiv: "w-2/5 flex flex-col items-end justify-between 2xl:h-72 h-72 divide-y-2 divide-[#151515]  reveal fade-right",
        rightItem: "flex flex-row items-center w-4/5 2xl:w-2/3 2xl:justify-around space-x-10 2xl:space-x-0 py-2 2xl:py-6",
        itemLeft: "flex items-center justify-center 2xl:h-20 2xl:w-20 h-16 w-16 bg-[#151515] rounded-2xl p-3",
    ...
    return (
        <div className={styles.main}>
            ...
            <div className={styles.middleDiv}>
                ...
                <div className={styles.button}><h1 className="text-[#151515] group-hover:text-accent transition duration-300 ease-in-out">Visit</h1><h1 className="text-accent group-hover:text-white transition duration-300 ease-in-out">Trainer</h1></div>
            </div>
